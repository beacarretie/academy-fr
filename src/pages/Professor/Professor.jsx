...
import ModalProfessor from "../../components/ModalProfessor/ModalProfessor";
...
import { bringProfessorsAppointmentsById, deleteAppointmentById } from "../../services/apiCalls";
...
export const Professor = () => {
  ...
  useEffect(() => {
    const fetchAppointments = async () => {
      const logedStudent = await bringProfessorsAppointmentsById(token);
      setAppointments(logedStudent);
    };
    fetchAppointments();
  }, []);
