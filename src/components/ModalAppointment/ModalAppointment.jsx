...
const uDecodificado = decodeToken(token);
  ...
  const professor_id = profileData.id;
  console.log("professor",professor_id,uDecodificado)
  
  const [appointmentData, setAppointmentData] = useState({
    day_date: "",
    description: "",
    professor: uDecodificado.userId,
    student: "",
    price: ""
  });
    ...
    <>
      ...
      <Modal show={show} onHide={handleClose}>
        ...
        <Modal.Body>
          ...
          <CustomInput
            typeProp="number"
            nameProp="professor_id"
            placeholderProp="professor_id"
            value={appointmentData.professor || ""}
            isDisabled="disabled"
            handlerProp={inputHandler}
          />
          <CustomInput
            typeProp="number"
            nameProp="student"
            placeholderProp="ID student"
            value={appointmentData.student || ""}
            isDisabled=""
            handlerProp={inputHandler}
          />
          <CustomInput
