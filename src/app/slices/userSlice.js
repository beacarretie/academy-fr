...
// método que nos dice si el usuario logeado es admin, professor o no, para uso en rutas privadas
export const amIAdmin =(state) => state.user.decodificado.userRole === "admin"

export const amIProfessor =(state) => state.user.decodificado.userRole === "professor"
